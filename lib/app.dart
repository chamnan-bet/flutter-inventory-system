...
import 'package:inventory_system/pages/settings_categories_page.dart';
import 'package:inventory_system/pages/settings_general_page.dart';
import 'package:inventory_system/pages/settings_users_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/settings/general': (_) => const SettingsGeneralPage(),
        '/settings/users': (_) => const SettingsUsersPage(),
        '/settings/categories': (_) => const SettingsCategoriesPage(),
      },
    );
  }
}
